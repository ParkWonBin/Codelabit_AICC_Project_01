...
function CreateTrafficChart() {
    ...
    tableSecondRow.append($(`<td class="percentageChange">30%</td>`))
    tableSecondRow.append($(`<td class="percentageChange">40%</td>`))
    tableSecondRow.append($(`<td class="percentageChange">55%</td>`))
    tableSecondRow.append($(`<td class="percentageChange">9%</td>`))
    tableSecondRow.append($(`<td class="percentageChange">20%</td>`))
    tableSecondRow.append($(`<td class="percentageChange">45%</td>`))
